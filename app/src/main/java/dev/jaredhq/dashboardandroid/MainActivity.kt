        ...
        NavHost(
            ...
            composable(Tab.Watch.route) {
                ...
                WatchHealthScreen(
                    ...
                    onWatchSongSelected = vm::onWatchSongSelected,
                    onRefreshWatchMusic = vm::refreshWatchMusicLibrary,
                    onCancelWatchSongImport = vm::cancelWatchSongImport,
                    onDeleteWatchSong = vm::deleteWatchSong,
                    onCreateWatchMusicFolder = vm::createWatchMusicFolder,
                    onUpdateWatchMusicFolder = vm::updateWatchMusicFolder,
                    onDeleteWatchMusicFolder = vm::deleteWatchMusicFolder,
                    onSongPickerErrorShown = vm::clearSongPickerError,
